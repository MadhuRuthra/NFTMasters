              ...
              <AuthCardWrapper>
                <Grid container spacing={2} sx={{ alignItems: 'center', justifyContent: 'center' }}>
                  ...
                  <Grid size={12}>
                    ...
                    <Typography component={Link} to="/pages/register" variant="subtitle1" sx={{ textDecoration: 'none', color: 'primary.main' }} > Don&apos;t have an account? <strong>Sign Up</strong></Typography>
                    </Grid>
                  </Grid>
                </Grid>
              </AuthCardWrapper>
