...
export default function ProfileSection() {
  ...
  const generateRandomNumber = () => Math.floor(100000000000 + Math.random() * 900000000000);

  const handleLogout = async (e) => {
      e.preventDefault();
      try {
          const response = await axios.post("http://localhost:10055/login/logout", {
              request_id: generateRandomNumber().toString(),
          }, {
              headers: {
                  "Content-Type": "application/json",
                  Authorization: sessionStorage.getItem("user_bearer_token") || "",
              },
          });
                    ...
                    >
                      ...
                      >
                        ...
                        <ListItemButton sx={{ borderRadius: `${borderRadius}px` }} selected={selectedIndex === 4}>
                          ...
                          <ListItemText primary={<Typography variant="body2"  onClick={handleLogout}>Logout</Typography>} />
                        </ListItemButton>
                      </List>
                    </Box>
                  </MainCard>
